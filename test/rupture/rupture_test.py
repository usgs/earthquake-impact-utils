...
from impactutils.rupture.factory import get_rupture, text_to_json
from impactutils.rupture.factory import rupture_from_dict
from impactutils.rupture.factory import validate_json

from impactutils.rupture.utils import (get_local_unit_slip_vector,
                                       get_local_unit_slip_vector_DS,
                                       get_local_unit_slip_vector_SS)
from impactutils.rupture.utils import (get_quad_slip,
                                       get_quad_strike_vector,
                                       get_quad_down_dip_vector)
from impactutils.rupture.utils import rake_to_mech
...
def get_lat_lon(row, col, xmin, ymax, GRIDRES):
    lon = xmin + col * GRIDRES
    lat = ymax - row * GRIDRES
