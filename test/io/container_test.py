...
def test_hdf_dictonaries():
    ...
    try:
        ...
        indict1 = {'name':'Fred','age':34,'dob':datetime(1950,1,1,23,43,12)}
...
def test_hdf_lists():
    ...
    try:
        ...
        #test getlists
        assert sorted(container.getLists()) == ['test_list1','test_list2','test_list3']
...
def test_hdf_dataframes():
    ...
    try:
        ...
        #test getdataframes
        assert sorted(container.getDataFrames()) == ['testframe1','testframe2']
