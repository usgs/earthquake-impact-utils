...
# local imports
from .point_rupture import PointRupture
from .quad_rupture import QuadRupture
from .edge_rupture import EdgeRupture
from .origin import Origin
from .utils import is_quad
from .constants import TIMEFMT, ALT_TIMEFMT, DEPTH_TOL
...
def _rotate_polygon(p):
    ...
    if not np.array_equal(parray[-1, :], parray[0, :]):
        raise Exception('Rupture file has unclosed segments.')
